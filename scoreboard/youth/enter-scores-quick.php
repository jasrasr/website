...
/**
 * Filename: youth/enter-scores-quick.php
 * Revision : 1.3.0
 ...
 * 1.3.0 Server-rendered quick-header block so View Source shows page identity and signed-in user
 */
...
<html lang="en">
  ...
  <body
    ...
    data-password-url="../change-password.php?return=youth/enter-scores-quick.php"
    data-scoreboards-url="../scoreboards.php"
  >
    <div id="quick-entry-app" class="quick-entry-shell">
      <header class="quick-header">
        <div class="quick-title">
          <h1>CVC Youth Scoreboard — Quick Entry</h1>
