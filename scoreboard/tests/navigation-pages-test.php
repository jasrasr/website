...
assertContains($changelog, 'Current project version: **v1.11.0**', 'CHANGELOG.md should state the current project version.');
assertContains($changelog, '## v1.11.0 - 2026-06-18', 'CHANGELOG.md latest entry should include project version and date.');
