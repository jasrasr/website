...
assertContains($changelog, 'Current project version: **v1.9.4**', 'CHANGELOG.md should state the current project version.');
assertContains($changelog, '## v1.9.4 - 2026-06-18', 'CHANGELOG.md latest entry should include project version and date.');
