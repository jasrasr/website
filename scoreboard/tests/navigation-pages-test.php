...
assertContains($changelog, 'Current project version: **v1.10.0**', 'CHANGELOG.md should state the current project version.');
assertContains($changelog, '## v1.10.0 - 2026-06-18', 'CHANGELOG.md latest entry should include project version and date.');
