...
<head>
  ...
  <link rel="stylesheet" href="styles.css?v=1.1.1"><script src="password-ui.js?v=1.2.0"></script><script src="app.js?v=1.1.2" defer></script>
</head>
<body>
...
<main>
  ...
  <div id="poll" hidden>
    ...
    <section class="panel"><h2>Everyone’s availability</h2><p class="muted">Names, availability, group counts, and food contributions are visible to anyone who can access this event. Phone numbers and emails are never shown here.</p><div id="response-table" class="table-scroll" tabindex="0" aria-label="Scroll to see all dates"></div></section>
...
<footer>availability <span>v1.2.0 · Updated September 17, 2026</span></footer>
</body></html>
