 ...
 * History: 1.3.1 — Remove committed conflict markers while preserving all 1.3.0 features; 1.3.0 — Admin-controlled attendee date suggestions; 1.2.0 — Optional hashed passwords for admin access and event/invite access; 1.1.1 — Single attendee name and Unicode-safe matching; 1.1.0 — Private contacts and event planning; 1.0.0 — Initial event polling API and protected JSON storage. */
