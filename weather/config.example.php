...
// Revision     : 1.8
// Description : Example configuration for the PHP weather dashboard.
//               Copy this file to config.php and add the real API key there.
// Changelog    :
...
//   Rev 1.8 - Converted tracked config to example-only file
// ============================================================================
