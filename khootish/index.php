...
$modifiedDate = 'Aug 16, 2026 11:57 AM EDT';
?>
...
<section class="card"><h2>Host controls</h2><p>Create reusable quizzes, manage the live lobby, launch rounds, archive game history, review statistics, and control the shared display.</p><a class="button" href="admin.php">Open admin</a></section></div>
