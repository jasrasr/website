...
$modifiedDate = 'Aug 16, 2026 12:07:00 PM EDT';
?>
...
<section class="card"><h2>Host controls</h2><p>Create reusable quizzes, launch rounds, archive game history, review statistics, and control the shared display.</p><a class="button" href="admin.php">Open admin</a></section></div>
