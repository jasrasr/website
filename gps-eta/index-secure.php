...
Created: 2026-06-30
Modified: 2026-06-30
Description: Wrapper entrypoint that loads index.php and injects client-side table rendering, trip-session, GPS quality, PHP trip-store helpers, and mobile layout refinements.
*/
...
if (is_string($html)) {
    $html = str_replace(
        ...
        'Rev 1.8.1 &bull; Updated 2026-06-30 &bull; Compact Mobile Distance Row',
        $html
    );
}
...
$scriptTag = '<script src="ui-render.js?v=1.5.1"></script><script src="trip-sessions.js?v=1.6.0"></script><script src="gps-quality.js?v=1.7.0"></script><script src="session-store.js?v=1.8.0"></script>';
