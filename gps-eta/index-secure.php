...
Created: 2026-06-30
Modified: 2026-06-30
Description: Wrapper entrypoint that loads index.php and injects client-side table rendering, trip-session, GPS signal, PHP trip-store helpers, mobile layout refinements, cleaned future-feature note wording, and combined speed/time rows.
*/
...
if (is_string($html)) {
    $html = str_replace(
        ...
        'Rev 1.8.4 &bull; Updated 2026-06-30 &bull; Combined Speed + Time Rows',
        $html
    );
...
$scriptTag = '<script src="ui-render.js?v=1.5.1"></script><script src="trip-sessions.js?v=1.6.0"></script><script src="gps-quality.js?v=1.8.2"></script><script src="metric-combiner.js?v=1.8.4"></script><script src="session-store.js?v=1.8.0"></script>';
