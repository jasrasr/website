...
if (is_string($html)) {
    $html = str_replace(
        ...
        'Rev 1.8.10 &bull; Updated 2026-06-30 &bull; Clear Dashboard Selection',
        $html
    );
