...
Created: 2026-06-30
Modified: 2026-06-30
Description: Wrapper entrypoint that loads index.php and injects client-side table rendering, trip-session, GPS signal, PHP trip-store helpers, mobile layout refinements, combined speed/time rows, no-key live map display, no-API trip enhancements, minute-based adjusted ETA, and sticky drive mode.
*/
...
if (is_string($html)) {
    $html = str_replace(
        ...
        'Rev 1.8.8 &bull; Updated 2026-06-30 &bull; Sticky Drive Mode',
        $html
    );
