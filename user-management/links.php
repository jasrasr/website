...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($action === 'preview') {
            ...
            $preview = $links->preview($actor['id'], $actor['version'], $_POST['legacy_id'] ?? '', $_POST['target_id'] ?? '');
