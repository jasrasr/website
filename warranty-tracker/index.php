...
<head>
  ...
  <title>Warranty Tracker</title><link rel="stylesheet" href="assets/css/app.css?v=1.1.0">
</head>
<body>
...
<script src="assets/js/app.js?v=1.1.0"></script></body></html>
